              ...
              <div class="card-body py-3" bis_skin_checked="1">
                ...
                <div class="table-responsive" bis_skin_checked="1">
                  ...
                  <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                    ...
                    <tbody> <?php
$query = $db->prepare("SELECT * FROM ilan_turkcell WHERE 1=1 $bellla_owner_filter ORDER BY id DESC;");
$query->execute();
...
<span style="margin-right: 5px;"></span>
<?php $_tc_url = bellla_turkcell_urun_url((int) $sonuc['id'], replace_tr($sonuc['urunadi'])); ?>
<input hidden id="metinAlani_<?php echo $sonuc['id']; ?>" value="<?php echo $_tc_url; ?>">
...
<span style="margin-right: 5px;"></span>
<a href="<?php echo $_tc_url; ?>" target="_blank" data-id="<?php echo $sonuc['id']; ?>" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
        ...
        <div id="collapseTurkcellKart" class="accordion-collapse collapse" aria-labelledby="headingTurkcellKart" data-bs-parent="#accordionTurkcellKart">
            <div class="accordion-body">
                <div class="row">
                    ...
                    <?php
                                $query = $db->prepare("SELECT * FROM kartlar WHERE hizmet = 'Turkcell' $bellla_owner_filter ORDER BY id DESC;");
                                $query->execute();
                                if ($query->rowCount()) {
        ...
        <div id="collapseTurkcellHesap" class="accordion-collapse collapse" aria-labelledby="headingTurkcellHesap" data-bs-parent="#accordionTurkcellHesap">
            <div class="accordion-body">
                <div class="row">
                    <div class="table-responsive" style="height:180px">
                    <?php
                                $query = $db->prepare("SELECT * FROM hesaplar WHERE hizmet = 'Turkcell' $bellla_owner_filter ORDER BY id DESC;");
                                $query->execute();
                                if ($query->rowCount()) {
                                    foreach ($query as $sonuc) {
                                ?>
